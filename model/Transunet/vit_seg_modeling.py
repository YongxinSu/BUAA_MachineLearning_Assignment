...
class Transunet(nn.Module):
    def __init__(self, config, zero_head=False, vis=False):
        ...
        assert config['model_name'] == 'Transunet'
        img_size = config['img_size']
        num_classes = config['num_classes']
        vit_name = config['vit_name']
        vit_patches_size = config['vit_patches_size']
        pretrained_path = config['pretrained_path']
        
        
        config = CONFIGS[vit_name]
        config.n_classes = num_classes
        config.patches.grid = (int(img_size / vit_patches_size), int(img_size / vit_patches_size))
